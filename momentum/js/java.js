...
function casualBackground(arrayBg)
{
    ...
    if  (hour>=6&&hour<12)
    {
        ...
        if (i<10)
            i=addZero(i);
        img.src="../images/morning/"+i+".jpg";
        img.onload=()=>{document.body.style.backgroundImage="url('../images/morning/"+i+".jpg')"};
    ...
    else
    {
        ...
        else
        {
            if (hour>=18&&hour<22)
            {
                ...
                if (i<10)
                    i=addZero(i);
                img.src="../images/evening/"+i+".jpg";
                img.onload=()=>{document.body.style.backgroundImage="url('../images/evening/"+i+".jpg')"};
            ...
            else
            {
                ...
                if (i<10)
                    i=addZero(i);
                img.src="../images/night/"+i+".jpg";
                img.onload=()=>{document.body.style.backgroundImage="url('../images/night/"+i+".jpg')"};
